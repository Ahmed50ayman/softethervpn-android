...
# 
# Platform: os=Android, bits=32bit
...
OPTIONS_LINK_DEBUG=-g -fsigned-char -static -static-libstdc++ -lm -ldl -lrt -lpthread -lssl -lcrypto -lreadline -lncurses -lz
...
OPTIONS_LINK_RELEASE=-O2 -fsigned-char -static -static-libstdc++ -lm -ldl -lrt -lpthread -lssl -lcrypto -lreadline -lncurses -lz

INSTALL_BINDIR=./release
INSTALL_VPNSERVER_DIR=./release/vpnserver/
INSTALL_VPNBRIDGE_DIR=./release/vpnbridge/
INSTALL_VPNCLIENT_DIR=./release/vpnclient/
INSTALL_VPNCMD_DIR=./release//vpncmd/
