...
OPTIONS_LINK_DEBUG=-g -fsigned-char  -static -static-libstdc++  -m64 -lm -ldl -lrt -lpthread -lssl -lcrypto -lreadline -lncurses -lz
...
OPTIONS_LINK_RELEASE=-O2 -fsigned-char -static -static-libstdc++ -m64 -lm -ldl -lrt -lpthread -lssl -lcrypto -lreadline -lncurses -lz
